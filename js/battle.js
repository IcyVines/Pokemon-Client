		...
		while (minors.length) {
			...
			case '-ability':
				...
				case 'intimidate':
					...
					break;
				case 'illuminate':
					actions += '' + poke.getName() + ' blinds ' + ofpoke.getLowerName() + '!';
					break;
				case 'underdog':
					actions += '' + poke.getName() + ' makes ' + ofpoke.getLowerName() + ' lower its guard!';
					break;
				case 'mindbreak':
					actions += '' + poke.getName() + ' breaks ' + ofpoke.getLowerName() + '\'s concentration!';
					break;
				case 'unnerve':
